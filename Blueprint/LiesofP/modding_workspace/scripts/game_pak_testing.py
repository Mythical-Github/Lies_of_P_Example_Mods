...
os.system("title Lies of P Mod Testing")

pak_list = (
    r"Paks\LogicMods", "Z_ExampleMod_P",        1, "off",
    r"Paks\LogicMods", "Z_Testing_P",           2, "on",    
    r"Paks\~mods",     "Z_ModLoader_P",         3, "on",
    r"Paks\LogicMods", "Z_CustomizableHair_P",  4, "on",
    r"Paks\LogicMods", "Z_PSX_Graphics_P",      5, "off"
)
pak_list_width =  4
...
old_prefix =      r"C:\Users\Mythical\Downloads\Output\WindowsNoEditor\LiesofP\Content\Paks\pakchunk"
old_suffix =      r"-WindowsNoEditorNoEditor"
new_prefix =      r"C:\Program Files (x86)\Steam\steamapps\common\Lies of P Demo\LiesofP\Content"
game_exe =        r"C:\Program Files (x86)\Steam\steamapps\common\Lies of P Demo\LiesofP\Binaries\Win64\LOP-Win64-Shipping.exe"
